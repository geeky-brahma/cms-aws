...
async function sendData(formData) {
    try {
        const response = await fetch('http://3.108.249.104:5000/complaint_details', {
            method: 'POST',
            headers: {
...
async function closeForward(formData) {
    try {
        const response = await fetch('http://3.108.249.104:5000/close_forward', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
...
async function fetchAllUsers() {
    try {
        const response = await fetch('http://3.108.249.104:5000/all_users', {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
            },
